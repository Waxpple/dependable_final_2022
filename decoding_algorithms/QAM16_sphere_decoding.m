%samples=2000000;
function QAM16_sphere_decoding(samples)
fprintf('16 QAM Sphere decoding detection with '+string(samples)+' samples\n');
eb_n0 = (0:2:20)';
...
xlabel('Eb/N0(dB)');
ylabel('BER');
title('4x4 16 QAM Sphere decoding detection with '+string(samples)+' samples');
