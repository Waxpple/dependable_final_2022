function QAM16_MMSE(samples)
fprintf('16 QAM MMSE detection with '+string(samples)+' samples\n');
eb_n0 = (0:2:20)';
...
xlabel('Eb/N0(dB)');
ylabel('BER');
title('4x4 16 QAM MMSE detection with '+string(samples)+' samples');
writematrix([eb_n0,ber],'data/QAM16_MMSE.txt');
