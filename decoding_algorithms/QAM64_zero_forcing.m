function QAM64_zero_forcing(samples)
fprintf('64 QAM Zero-forcing detection with '+string(samples)+' samples\n');
eb_n0 = (0:2:20)';
...
xlabel('Eb/N0(dB)');
ylabel('BER');
title('4x4 64 QAM Zero-forcing detection with '+string(samples)+' samples');
writematrix([eb_n0,ber],'data/QAM64_zero_forcing.txt');
